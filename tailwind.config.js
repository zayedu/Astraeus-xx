    ...
    extend: {
      colors: {
        ...
        rbc: {
          ...
          // New Stripe-inspired text gradient colors
          "text-gradient-start": "#635BFF", // A vibrant blue/purple
          "text-gradient-middle": "#8A63FF", // A lighter purple
          "text-gradient-end": "#FF63C3", // A bright pink
        },
      },
      borderRadius: {
        lg: "var(--radius)",
